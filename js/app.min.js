...
Handlebars.registerHelper("select", selectHelper),
    function(e, t) {
        e.views = {
            ...
            skills: 5,
            spells: 5
        }, e.profiles = {}, e.attributes = {}, e.skills = [], e.spells = [], e.perks =[], e.mutations = [], e.injuries = [], e.books = [], e.equipment = {}, e.resistances = {}, e.initiatives = {}, e.points = {}, e.types = {}, e.activeProfile = {}, e.baseProfile = {
            name: "",
            title: "",
            type: "",
            warband: "",
			...
			var norMax = e.activeProfile.attributes[attr].max.current < e.activeProfile.attributes[attr].max.type ? e.activeProfile.attributes[attr].max.current : e.activeProfile.attributes[attr].max.type;
			var enchMaxTmp = norMax + e.activeProfile.attributes[attr].enchant;
		...
		e.getEnchantedValue = function(attr) {
			...
			var enchCurTmp = e.activeProfile.attributes[attr].value + e.activeProfile.attributes[attr].enchant;
		...
		e.attributeUpdate = function(i, a) {
            ...
            e.views.loading = $("#view-loading"), e.views.profileicons = $("#view-profileicons"), e.views.profile = $("#view-profile"), e.panels.skills = $("#panel-skills"), e.panels.spells = $("#panel-spells"), e.panels.perks = $("#panel-perks") ,e.panels.mutations = $("#panel-mutations"), e.loadData(), e.parseTemplatesHandlebars(), e.uiHandlerAttributes(), e.uiHandlerSkills(), e.uiHandlerSpells(), e.uiHandlerMutations(), e.uiHandlerInjuries(), e.uiHandlerBooks(), e.uiHandlerEquipment(), e.uiHandlerProfile(), e.uiHandlerDataLoaded(), e.uiHandlerButtonQuicklink(), e.uiHandlerButtonQuicksummary()
        }
